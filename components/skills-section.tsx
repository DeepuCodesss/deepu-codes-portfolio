...
export function SkillsSection({ onVisible }: SkillsSectionProps) {
  ...
  return (
    ...
    >
      {/* Background glow */}
      <div className="absolute top-1/2 left-0 w-[400px] h-[400px] bg-cyan-500/5 rounded-full blur-[150px] pointer-events-none" />

      <div className="max-w-5xl mx-auto px-6 relative">
        <h2 className="flex items-center gap-4 text-2xl md:text-3xl font-bold text-foreground mb-12">
          <span className="text-accent font-mono text-lg md:text-xl">03.</span>
          Skills & Technologies
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          {skills.map((skill, index) => (
            <div
              key={skill.name}
              className="group p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/50 hover:border-accent/30 transition-all duration-500 hover:-translate-y-2"
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="w-full">
                  ...
                  <div className="h-2 bg-secondary rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-accent to-cyan-400 rounded-full transition-all duration-1000 ease-out"
        ...
        <div className="text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {additionalSkills.map((skill) => (
              <span
                key={skill}
                className="px-4 py-2 text-sm font-medium text-muted-foreground bg-card/50 border border-border/50 rounded-xl hover:border-accent/30 hover:text-accent hover:bg-accent/5 transition-all duration-300 cursor-default"
              >
                {skill}
              </span>
            ))}
